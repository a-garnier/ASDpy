...
_classifiers : contient les modèles (format .h5)
```
...
cnn2/3_cnn2_fit.ipynb : entraine un modèle cnn sur les images des machine dans _data_png_cnn2 + enregistre un modèle lobal dans _classifiers
cnn2/4_cnn2_use.ipybn : utilise le modèle cnn global sur les données de test _data_png_cnn2 et affiche les résultats
```
